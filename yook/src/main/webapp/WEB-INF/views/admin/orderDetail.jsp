...
function order_list() {
	...
	location.href="/yook/adminOrderList.do?os="+os;
	return;	
}
...
<div class="container" style="width:50%; margin-left:500px;">
	<div class="row">
	<div align="center" style="margin-top:100px; margin-bottom:50px; margin-left:300px;">
   	<h3>주문상세</h3> 
	</div>
        ...
        <table class="table">
        	...
        	<tr>
        		<th>배송지</th><td>${detail.ORDER_ZIPCODE } <br> ${detail.ORDER_DADD1 } ${detail.ORDER_DADD2 }</td>
        	</tr>
        	<tr>
        ...
        <table class="table">
			...
			<tr>
				...
				<tr>	
					<th>사용 포인트</th><td>${detail.ORDER_POINT }점</td>
				</tr> --%>
				<tr>	
	...
	<div class="table-responsive">
		<table class="table table-striped">
			...
			<thead>
				<tr>
					<th scope="col" align="left">제품명</th>
				...
				<c:when test="${fn:length(order_detail_sub) > 0}">
					<c:forEach items="${order_detail_sub }" var="detail_sub">					
						<tr>
							...
							<td align="center">${detail_sub.GOODS_PRICE}원</td>
							<td align="center">${detail_sub.ORDER_DETAIL_AMOUNT }개</td>
							<td align="center">${detail_sub.GOODS_PRICE*detail_sub.ORDER_DETAIL_AMOUNT}원</td>
