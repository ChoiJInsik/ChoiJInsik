...
<ul class="nav nav-tabs">
     <li class="active">
       <a class="nav-link" href="<c:url value='/adminOrderList.do'/>">주문관리</a>
     </li>
     <li class="nav-item">
       <a class="nav-link active" href="<c:url value='/adminETCList.do?as=4'/>">교환/반품/취소</a>
     </li>
</ul></div>
		...
		<nav>
			...
			<c:choose>
				<c:when test="${fn:length(as_admin_list) > 0}">
                  ...
                  |&nbsp;<li class="active"><a href="/yook/adminETCList.do?as=4" style="text-decoration:none; color:black;"><strong>취소 접수</strong></a> | </li>&nbsp;
                  </c:when>
                  <c:otherwise>
                  |&nbsp;<li><a href="/yook/adminETCList.do?as=4">취소 접수</a> | </li>&nbsp;
                  </c:otherwise>
               </c:choose>
               <c:choose>
                  <c:when test="${state.AORDER_STATE eq '5' }">
                  <li class="active"><a href="/yook/adminETCList.do?as=5" style="text-decoration:none; color:black;"><strong>취소 완료</strong></a> | </li>&nbsp;
                  </c:when>
                  <c:otherwise>
                  <li><a href="/yook/adminETCList.do?as=5">취소 완료</a> | </li>&nbsp;
                  </c:otherwise>
               </c:choose>
					<c:choose>
						<c:when test="${state.AORDER_STATE eq '6' }">
						<li class="active"><a href="/yook/adminETCList.do?as=6" style="text-decoration:none; color:black;"><strong>교환 접수 </strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/yook/adminETCList.do?as=6">교환 접수 </a> | </li>&nbsp;
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${state.AORDER_STATE eq '7' }">
						<li class="active"><a href="/yook/adminETCList.do?as=7" style="text-decoration:none; color:black;"><strong>교환 중 </strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/yook/adminETCList.do?as=7">교환 중 </a> | </li>&nbsp;
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${state.AORDER_STATE eq '8' }">
						<li class="active"><a href="/yook/adminETCList.do?as=8" style="text-decoration:none; color:black;"><strong>교환 완료 </strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/yook/adminETCList.do?as=8">교환 완료 </a> | </li>&nbsp;
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${state.AORDER_STATE eq '9' }">
						<li class="active"><a href="/yook/adminETCList.do?as=9" style="text-decoration:none; color:black;"><strong>반품 접수 </strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/yook/adminETCList.do?as=9">반품 접수 </a> | </li>&nbsp;
						</c:otherwise>
					</c:choose>
					<c:choose>
						<c:when test="${state.AORDER_STATE eq '10' }">
						<li class="active"><a href="/yook/adminETCList.do?as=10" style="text-decoration:none; color:black;"><strong>반품 완료</strong></a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/yook/adminETCList.do?as=10">반품 완료</a> | </li>&nbsp;
						</c:otherwise>
					</c:choose>
					</c:forEach>
				</c:when>
               ...
               <c:choose>
                  ...
                  <li class="active"><a href="/yook/adminETCList.do?as=5" style="text-decoration:none; color:black;">취소 완료</a> | </li>&nbsp;
                  </c:when>
                  <c:otherwise>
                  <li><a href="/yook/adminETCList.do?as=5">취소 완료</a> | </li>&nbsp;
                  </c:otherwise>
					...
					<c:choose>
						...
						<li class="active"><a href="/yook/adminETCList.do?as=6" style="text-decoration:none; color:black;">교환 접수</a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/yook/adminETCList.do?as=6">교환 접수 </a> | </li>&nbsp;
						</c:otherwise>
					...
					<c:choose>
						...
						<li class="active"><a href="/yook/adminETCList.do?as=7" style="text-decoration:none; color:black;">교환 중</a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/yook/adminETCList.do?as=7">교환 중 </a> | </li>&nbsp;
						</c:otherwise>
					...
					<c:choose>
						...
						<li class="active"><a href="/yook/adminETCList.do?as=8" style="text-decoration:none; color:black;">교환 완료</a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/yook/adminETCList.do?as=8">교환 완료 </a> | </li>&nbsp;
						</c:otherwise>
					...
					<c:choose>
						...
						<li class="active"><a href="/yook/adminETCList.do?as=9" style="text-decoration:none; color:black;">반품 접수</a> | </li>&nbsp;
						</c:when>
						<c:otherwise>
						<li><a href="/yook/adminETCList.do?as=9">반품 접수 </a> | </li>&nbsp;
						</c:otherwise>
