...
public class GoodsDao extends AbstractDAO {
	 ...
	 * newGoodsList(Map<String, Object> map) throws Exception { // 최신 상품 리스트
	 * 
	 * return (List<Map<String, Object>>) newGoodsList("goods.newGoodsList", map); }
	 */
	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> bestGoodsList(Map<String, Object> map) throws Exception { // 전체 상품 리스트

		return (List<Map<String, Object>>) GoodsList("goods.bestGoodsList", map);
	}

	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> GoodsListAll(Map<String, Object> map) throws Exception { // 전체 상품 리스트

		return (List<Map<String, Object>>) GoodsList("goods.GoodsListAll", map);
	}

	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> GoodsListPig(Map<String, Object> map) throws Exception { // 전체 상품 리스트

		return (List<Map<String, Object>>) GoodsList("goods.GoodsListPig", map);
	}

	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> GoodsListCow(Map<String, Object> map) throws Exception { // 전체 상품 리스트

		return (List<Map<String, Object>>) GoodsList("goods.GoodsListCow", map);
	}

	@SuppressWarnings("unchecked")
	public List<Map<String, Object>> GoodsListChicken(Map<String, Object> map) throws Exception { // 전체 상품 리스트
	...
	/*
	 * @SuppressWarnings("unchecked") public List<Map<String, Object>>
	 * cateGoodsList(Map<String, Object> map) throws Exception { // 카테고리 별 상품 리스트
	 * System.out.println("카테고리리스트" + map); return (List<Map<String, Object>>)
	...
	public void goodsAttributeInsert(Map<String, Object> map) throws Exception { // 상품옵션 등록
		insert("goods.attributeInsert", map);
	}

	public void goodsAttributeUpdate(Map<String, Object> map) throws Exception { // 상품옵션 등록
