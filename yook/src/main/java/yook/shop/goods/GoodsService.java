...
public interface GoodsService {
	...
	List<Map<String, Object>> GoodsListAll(Map<String, Object> map) throws Exception; // 베스트 상품 리스트
	 ...
	 * GOODS_CATEGORY2) throws Exception; // 카테고리별 상품순
	 */
	...
	Map<String, Object> selectGoodsDetail(Map<String, Object> map, HttpServletRequest request) throws Exception; // 상품
																													// 디테일
