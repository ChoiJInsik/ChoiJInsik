...
import yook.admin.aorder.AdminOrdersService;
...
public class AdminOrdersController {
	...
	public ModelAndView order_detail(CommandMap commandMap, HttpServletRequest request) throws Exception {
		...
		ModelAndView mv = new ModelAndView("adminOrderDetail");
	...
	// state변경
	@RequestMapping(value = "/adminOrderList.do", method = RequestMethod.POST)
